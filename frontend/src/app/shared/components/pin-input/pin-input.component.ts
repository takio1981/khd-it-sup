    ...
    <div class="flex justify-center gap-2 sm:gap-3">
      @for (i of indices; track i) {
        <input
          ...
          [value]="digits()[i]"
          [disabled]="disabled()"
          class="w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-xl font-semibold rounded-xl border border-neutral-300 dark:border-neutral-600 bg-transparent text-neutral-900 dark:text-white focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/30 outline-none transition disabled:opacity-50 disabled:cursor-not-allowed"
