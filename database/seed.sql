...
(UUID(), 'REPAIR_REQUEST_GENERAL', 'RG-', 'CE', 0, 1),
(UUID(), 'EXTERNAL_APPROVAL', 'EA-', 'CE', 0, 1);

-- =====================================================================================
-- 10. DOCUMENT TEMPLATES (registry เท่านั้น — เนื้อหาฟอร์มจริง render ฝั่ง frontend
-- ที่ต่อสายใช้งานจริงแล้ว: REPAIR_REQUEST (คอมพิวเตอร์/อุปกรณ์คอมพิวเตอร์) และ REPAIR_REQUEST_GENERAL
-- (งานทั่วไป/เครื่องใช้ไฟฟ้า/ครุภัณฑ์อื่นๆ ที่ไม่ใช่คอมพิวเตอร์) รอต้นแบบฟอร์มราชการอื่นเพิ่มทีหลังโดยไม่ต้องแก้ engine)
-- =====================================================================================
...
(UUID(), 'REPAIR_REQUEST_GENERAL', 'ใบแจ้งซ่อม (งานทั่วไป/เครื่องใช้ไฟฟ้า/ครุภัณฑ์อื่นๆ)', 'ใบแจ้งซ่อมสำหรับงานที่ไม่ใช่คอมพิวเตอร์/อุปกรณ์คอมพิวเตอร์ เช่น ไฟฟ้า ประปา สุขาภิบาล ปรับอากาศ งานอาคาร ครุภัณฑ์ทั่วไป — พิมพ์จากหน้ารายละเอียดใบแจ้งซ่อมเช่นเดียวกัน', 1);
